                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select id="subsektor" name="subsektor" class="form-select form-select-sm">
                                            ...
                                            <option data-sektor="Tanaman Pangan" value="Kacang-kacangan dan Umbi-umbian">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select id="kategori" name="kategori" class="form-select form-select-sm">
                                            ...
                                            <option data-subsektor="Pakan Ternak" value="Rumput Pakan Ternak">Rumput
                                                Pakan Ternak</option>
                                            <option data-subsektor="Pakan Ternak" value="Kacang-kacangan Pakan Ternak">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="jenis" required>
                                                    <option value="Bantuan" {{ $item->jenis == 'Bantuan' ? 'selected' : '' }}>
                                                        Bantuan</option>
                                                    <option value="Subsidi" {{ $item->jenis == 'Subsidi' ? 'selected' : '' }}>
                                                        Subsidi</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="status" required>
                                                    ...
                                                    <option value="Nonaktif"
                                                        {{ $item->status == 'Nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                                                </select>
                                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ route('psp.store') }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label class="form-label">Sektor <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="sektor" required
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="kategori" required
                                                placeholder="Contoh: Alat dan Mesin">
                                        </div>
